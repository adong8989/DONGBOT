...
# === ephemeral store for latest generated signals ===
LATEST_SIGNALS = {}
...
def fake_human_like_reply(msg, line_user_id):
    ...
    priority = "組合 A 優先" if sums[0] > sums[1] else "組合 B 優先" if sums[1] > sums[0] else "兩組同等優先"
    ...
    with ApiClient(configuration) as api_client:
        ...
        if msg == "我要開通":
            ...
            if ADMIN_LINE_ID and user_id == ADMIN_LINE_ID:
                ...
                reply = f"管理員操作完成，已儲存 {saved_count} 位使用者訊號。"
            else:
